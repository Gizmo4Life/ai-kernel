...
instructions: [ review-pull-request.instruction,  maintain-kernel-integrity.instruction, resolve-naming-ambiguity.instruction, kernel-first-remediation.instruction ]
