---
id: architecture-review.instruction
title: Architecture Review Protocol
type: instruction
tags: [architecture, review, design, quality]
summary: A protocol for verifying that a proposed change adheres to the project's architectural topology and capability boundaries.
parent_standard: instruction-file.standard
glossary_refs: [capability.glossary, instruction.glossary, standard.glossary]
---
...
```mermaid
graph TD
    instruction-file.standard --> architecture-review.instruction
```
