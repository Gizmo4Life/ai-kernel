...
skills: [ validate-documentation.skill, audit-runbook-completeness.skill,  audit-content-quality.skill,  audit-for-architectural-violations.skill, detect-circular-delegation.skill, evaluate-against-standard.skill, check-id-uniqueness.skill,  find-similar-terms.skill, detect-circular-delegation.skill, audit-frontmatter-completeness.skill ]
...
graph TD
    ...
    integrity-guardian.agent --> validate-documentation[validate-documentation.skill]
    integrity-guardian.agent --> audit-runbook-completeness[audit-runbook-completeness.skill]
