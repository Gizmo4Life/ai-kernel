...
type: standard
tags: [ops, docker, orchestration, container]
status: stable
version: 1.0.0
padu:
  P: "Multi-stage, slimmed-down production images with strict non-root execution."
...
glossary_refs: [orchestration.glossary, standard.glossary]
