...
glossary_refs: [agent.glossary, context.glossary, instruction.glossary, knowledge-graph.glossary, skill.glossary, standard.glossary, subject-matter-expert.glossary]
---
...
```mermaid
graph TD
    agent-file.standard --> semantic-auditor.agent
```
