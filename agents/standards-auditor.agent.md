...
glossary_refs: [agent.glossary, context.glossary, skill.glossary, standard.glossary, subject-matter-expert.glossary]
---
...
```mermaid
graph TD
    agent-file.standard --> standards-auditor.agent
```
