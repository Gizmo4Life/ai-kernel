...
implementation:
  engine: "python3 drivers/standard_auditor.py"
  command: "python3 drivers/standard_auditor.py {{standard_id}} {{target_path}}"
...
3. Run `python3 drivers/standard_auditor.py test.standard test.file`.
